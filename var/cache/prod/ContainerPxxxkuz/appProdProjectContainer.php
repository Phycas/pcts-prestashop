...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory(array())) && false ?: '_'}->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => '', 'dbname' => 'prestashop', 'user' => 'tesportable', 'password' => 'dev2018', 'charset' => 'UTF8', 'driverOptions' => array(1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'), 'serverVersion' => 5.1, 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array('enum' => 'string'));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b->setNamingStrategy(${($_ = isset($this->services['prestashop.database.naming_strategy']) ? $this->services['prestashop.database.naming_strategy'] : $this->services['prestashop.database.naming_strategy'] = new \PrestaShopBundle\Service\Database\DoctrineNamingStrategy('tesportable_market')) && false ?: '_'});
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_6491594a51ef17b47d74f71fde4f7b848982b1b3468db612a2224c4a74e18f7d');
    ...
    {
        return $this->services['prestashop.database.naming_strategy'] = new \PrestaShopBundle\Service\Database\DoctrineNamingStrategy('tesportable_market');
    }
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('ZBc1RZEaLWfIRMKqvSe3Reudnji4Wb4YmrxyMEPGy74SKjUJafW8TaEN')) && false ?: '_'}, '/_fragment');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('ZBc1RZEaLWfIRMKqvSe3Reudnji4Wb4YmrxyMEPGy74SKjUJafW8TaEN');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_user' => 'tesportable',
            'database_password' => 'dev2018',
            'database_prefix' => 'tesportable_market',
            'database_engine' => 'InnoDB',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => 'ZBc1RZEaLWfIRMKqvSe3Reudnji4Wb4YmrxyMEPGy74SKjUJafW8TaEN',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2018-09-04',
            'locale' => 'en-US',
            'cookie_key' => 'TbcZCL4zteovaOr5fOM5hF1X8x82RrNuIa1NBL34RRnoCxEU7A3PTKKm',
            'cookie_iv' => 'WnZEDcor',
            'new_cookie_key' => 'def00000c868315161b7086e4b148bc553aae6040b7b28a81eb9dda35dcb3a835973184bac64566e263064bd6e6e58ac9af3e0fdc4b0449ff6772fd9b7e24928a157d304',
            'cache.driver' => 'array',
            ...
            'kernel.secret' => 'ZBc1RZEaLWfIRMKqvSe3Reudnji4Wb4YmrxyMEPGy74SKjUJafW8TaEN',
